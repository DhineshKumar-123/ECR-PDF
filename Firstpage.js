...
const MergedComponent = () => {
  ...
  const handleGenerateAndDownload = async () => {
    try {
      ...
      newPdf.addImage(Image3, 'JPG', 175, 10, 17, 10);
      newPdf.addImage(Image4, 'JPG', 175, 24, 20, 14);
      ...
      newPdf.text('EVENT COMPLETION REPORT', 75  , 46);

newPdf.rect(170, 40, 30, 7);
newPdf.text(`   ${data.acdyr_id}`, 174.5, 45);//Academic year
...
newPdf.text("Rs. "+`${data.event_budget}`, 113, 197.5);////Event Budget

newPdf.rect(10, 201, 100, 50).stroke();
newPdf.addImage(picture1,"JPEG",15,205,90,45);
newPdf.rect(110, 201, 90, 50).stroke();
newPdf.addImage(picture2,"JPEG",115,205,90,45);
...
newPdf.addImage(HoDSign, 'JPEG', 90, 280, 10, 10);

newPdf.text('HoD', 100, 295);
newPdf.addImage(CoordinatorSign, 'PNG', 10, 280, 10, 10);
...
newPdf.rect(170, 40, 30, 7);
newPdf.text(`${data.acdyr_id}`, 177.5, 45);//academic year
...
newPdf.rect(110, 205, 90, 10).stroke();
newPdf.text("Rs. "+`${data.event_budget}`, 113, 211);//Event Budget
...
newPdf.addPage();
newPdf.addImage(Image, 'PNG', 10, 7, 25, 25);
newPdf.addImage(Image2, 'PNG', 173, 7, 25, 17);
newPdf.setFontSize(18);
newPdf.setFont("Calibri", "bold");
newPdf.text('MUTHAYAMMAL ENGINEERING COLLEGE',35, 15);
newPdf.setFontSize(10);
...
newPdf.setFont("Calibri", "bold");
newPdf.setFontSize(12);
newPdf.text('Budget Proposal', 87, 45);
newPdf.setFontSize(12);
...
newPdf.addPage();
newPdf.addImage(Image, 'PNG', 10, 7, 25, 25);
newPdf.addImage(Image2, 'PNG', 173, 9, 25, 17);
newPdf.setFontSize(18);
newPdf.setFont("Calibri", "bold");
newPdf.text('MUTHAYAMMAL ENGINEERING COLLEGE',35, 15);
newPdf.setFontSize(10);
...
newPdf.setFont('Calibri', 'bold');
newPdf.rect(8,58,60,10).stroke();

newPdf.text('Event Date: ',14,65);
newPdf.text(`${data.event_date}`,40,65);////Event Date 
...
newPdf.addImage(Image, 'PNG', 10, 7, 25, 25);
    ...
    generateCenteredText(newPdf,`${data.event_name}`,16,75,'Calibri','bold',[150, 6, 6]);
...
newPdf.rect(55,40,95,15)
const title1 = newPdf.splitTextToSize(`${data.event_title}`,80)
newPdf.text(title1,60, 46);//topic

newPdf.rect(165,40,25,10)
newPdf.text( `${data.acdyr_id}`,170, 46);//academic year

generateCenteredText(newPdf,'Event Photos',15,65,'Calibri','bold',[0, 0, 0]);
...
newPdf.setFont("Calibri", "bold");
newPdf.setFontSize(12);
newPdf.text('Budget Utilized', 87, 45);
newPdf.setFontSize(12);
newPdf.text('Date of the Event:', 15, 60);
////newPdf.setFont("Calibri","");
...
newPdf.text('Overall Budget', 35, 120);
newPdf.rect(155, 112, 45, 12).stroke();
newPdf.text("Rs. "+`${data.event_budget_utilized}`, 157, 120); // budget
...
newPdf.text('Total', 35, 132);
newPdf.rect(155, 124, 45, 12).stroke();
newPdf.text("Rs. "+`${data.event_budget_utilized}`, 157, 132); //total budget
newPdf.rect(15, 136, 185, 12).stroke();
newPdf.text('In Words:', 19, 144);
newPdf.text(`${data.budget_words}`,37,144);//In words budget
