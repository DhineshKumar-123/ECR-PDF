...
doc.text('10.', 12, 220);
doc.rect(20, 215, 180, 10).stroke();
doc.text('Co-ordinator of the Event',22, 220);

doc.rect(10, 225, 70, 5).stroke();
doc.text('Name', 35, 229);

doc.rect(80, 225, 60, 5).stroke();
doc.text('Designation', 100, 229);

doc.rect(140, 225, 60, 5).stroke();
doc.text('Phone Number', 155, 229);


doc.rect(10, 230, 70, 35).stroke();


doc.rect(80, 230, 60, 35).stroke();


doc.rect(140, 230, 60, 35).stroke();


// doc.rect(20, 225, 180, 10).stroke();
// doc.text('',22, 220);
...
doc.text('HoD', 15, 290);
// doc.addImage(Sign,"JPEG",50,150,50,50); 
